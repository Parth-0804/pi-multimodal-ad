...
The versioned table contains 7,124 LF HDF5 source records across 20 experiment/runs. 7,119 have verified UTC `wf_start_time` and enter chronological model sequences; 5 remain traceable but excluded.
